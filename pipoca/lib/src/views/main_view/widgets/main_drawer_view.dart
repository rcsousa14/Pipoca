...
import 'package:pipoca/src/views/main_view/widgets/main_drawer_view_model.dart';
        ...
        return SizedBox(
          ...
          child: Drawer(
            child: Container(
              ...
              child: Column(
                children: [
                  SizedBox(width: width * .65, height: height * .3, child: _DrawerHeader()),
...
Widget drawerList() {
  List<ListData> data = [
    ...
    ListData(icon: Icon(FontAwesomeIcons.solidHeart, color: red,), text: 'Partilhar o App'),
